...
class HotelControllerTest {
  ...
  void hotelCreatedCorrectly() throws Exception {
    ...
    @Test
    @DisplayName("When a hotel is requested by id and exist then it is loaded")
    void hotelLoadedCorrectly() throws Exception {
        City city =
                cityRepository
                        .findById(1L)
                        .orElseThrow(
        ...
        newHotel = repository.save(newHotel);
        ...
        assertThat(resultHotel, equalTo(newHotel));
    }

    @Test
    @DisplayName("When a hotel is requested by id and not exist then throw ElementNotFoundException")
    void hotelLoadedWithError() throws Exception {
        ...
        mockMvc
                ...
                .andExpect(result -> assertThat("Hotel is not found", result.getResolvedException() instanceof ElementNotFoundException))
                .andReturn()
                .getResponse()
                .getContentAsString();
    }
    ...
    @Test
    @DisplayName("When a hotel is exist then it is deleted")
    ...
    @Test
    @DisplayName("When a hotel is DELETED by id and not exist then throw ElementNotFoundException")
    void hotelDELETEDWithError() throws Exception {
